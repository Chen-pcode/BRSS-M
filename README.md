...
1. Create a Kaggle Dataset containing this directory, then attach it to a GPU
   notebook together with the skin-data Dataset.
...
```bash
python train.py --data-root /kaggle/input/skin-lesion-data --epochs 2 --workers 2 --amp --output-dir /kaggle/working/smoke
```
...
```bash
python run_ablations.py --data-root /kaggle/input/skin-lesion-data --amp --output-root /kaggle/working/ablation --skip-completed
```
...
```bash
python run_ablations.py --data-root /kaggle/input/skin-lesion-data --train-dataset isic2017 --val-dataset isic2017 --test-datasets isic2018 PH2 --amp --output-root /kaggle/working/ablation_isic2017
```
...
data/
  ...
  PH2Dataset/ph2/test/{images,masks}
```
