...
def arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--model", choices=sorted({*ABLATIONS, *LOSS_ABLATIONS}), default="brss_raster_mamba")
    parser.add_argument("--experiment-name", default=None, help="Result label; defaults to --model.")
    parser.add_argument("--output-dir", default="./outputs/brss_raster_mamba")
